...
# Function for converting score percentage to grade (Menu option 3)
...
# Function to process the input string (Menu option 5)
...
# Function to compare numbers (Menu option 6)
def compare_numbers():
...
def validate_personnummer(pnr):
    ...
    for index, digit in enumerate(digits):  # Refactored loop
